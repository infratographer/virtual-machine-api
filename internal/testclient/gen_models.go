...
type CreateVirtualMachineInput struct {
	...
	VirtualMachineMemoryConfigID gidx.PrefixedID `json:"virtualMachineMemoryConfigID"`
}
...
type VirtualMachine struct {
	...
	VMMemoryConfigID gidx.PrefixedID `json:"vmMemoryConfigID"`
	...
	VirtualMachineMemoryConfig VirtualMachineMemoryConfig `json:"virtualMachineMemoryConfig"`
...
func (VirtualMachineMemoryConfig) IsNode() {}

// The id of the object.
func (this VirtualMachineMemoryConfig) GetID() gidx.PrefixedID { return this.ID }

func (VirtualMachineMemoryConfig) IsEntity() {}

// A connection to a list of items.
type VirtualMachineMemoryConfigConnection struct {
	// A list of edges.
	Edges []*VirtualMachineMemoryConfigEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type VirtualMachineMemoryConfigEdge struct {
	// The item at the end of the edge.
	Node *VirtualMachineMemoryConfig `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}
...
type VirtualMachineMemoryConfigOrderField string

const (
	VirtualMachineMemoryConfigOrderFieldID   VirtualMachineMemoryConfigOrderField = "ID"
	VirtualMachineMemoryConfigOrderFieldSize VirtualMachineMemoryConfigOrderField = "SIZE"
)

var AllVirtualMachineMemoryConfigOrderField = []VirtualMachineMemoryConfigOrderField{
	VirtualMachineMemoryConfigOrderFieldID,
	VirtualMachineMemoryConfigOrderFieldSize,
}

func (e VirtualMachineMemoryConfigOrderField) IsValid() bool {
	switch e {
	case VirtualMachineMemoryConfigOrderFieldID, VirtualMachineMemoryConfigOrderFieldSize:
		return true
	}
	return false
}

func (e VirtualMachineMemoryConfigOrderField) String() string {
	return string(e)
}

func (e *VirtualMachineMemoryConfigOrderField) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = VirtualMachineMemoryConfigOrderField(str)
	if !e.IsValid() {
...
func (e VirtualMachineMemoryConfigOrderField) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}
...
const (
	...
	VirtualMachineOrderFieldVMMemoryConfig VirtualMachineOrderField = "VM_MEMORY_CONFIG"
)
...
var AllVirtualMachineOrderField = []VirtualMachineOrderField{
	...
	VirtualMachineOrderFieldVMMemoryConfig,
}

func (e VirtualMachineOrderField) IsValid() bool {
	switch e {
	case VirtualMachineOrderFieldID, VirtualMachineOrderFieldCreatedAt, VirtualMachineOrderFieldUpdatedAt, VirtualMachineOrderFieldName, VirtualMachineOrderFieldOwner, VirtualMachineOrderFieldVMCPUConfig, VirtualMachineOrderFieldVMMemoryConfig:
		return true
	}
	return false
}
