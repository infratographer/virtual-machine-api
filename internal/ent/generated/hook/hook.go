...
// The VirtualMachineMemoryConfigFunc type is an adapter to allow the use of ordinary
// function as VirtualMachineMemoryConfig mutator.
type VirtualMachineMemoryConfigFunc func(context.Context, *generated.VirtualMachineMemoryConfigMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f VirtualMachineMemoryConfigFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.VirtualMachineMemoryConfigMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.VirtualMachineMemoryConfigMutation", m)
}
