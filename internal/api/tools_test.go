...
import (
	...
	"go.infratographer.com/virtual-machine-api/db"
	...
	"go.infratographer.com/virtual-machine-api/internal/testclient"
)

var (
	TestDBURI   = os.Getenv("VIRTUALMACHINEAPI_TESTDB_URI")
